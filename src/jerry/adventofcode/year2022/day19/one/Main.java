package jerry.adventofcode.year2022.day19.one;
...
/*
sample output: 33 // 2 milliseconds
real output: 1150 // 2 milliseconds
 */
public class Main {
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (String line : lines) {
      ...
      optimize(blueprint, 1, 0, 0, 0, 0, 0, 0, 0, 24);
      sum += blueprint.id * optimumCost;
      optimumCost = 0;
    }
