package jerry.adventofcode.year2022.day24.two;
...
public class Main {
  ...
  private static Node initNode = new Node(0, 1);
    ...
    for (int step = 0; step < STEPS; ++step) {
      ...
      for (Node currentPosition : possiblePositions) {
        if (currentPosition.equals(ultimateNode)) {
          ...
          ++tripCount;
          Node temp = ultimateNode;
          ultimateNode = initNode;
          initNode = temp;
          newPossiblePositions = new HashSet<>();
          break;
        }
